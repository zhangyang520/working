...
public class FileTransYifaActivity extends BaseActivity {
		...
		if (mLoadingPager == null) {
			mLoadingPager = new LoadingPager(UiUtils.getContext()) {
				...
				public View createSuccessView() {
					FileTransDetailHolder mFileTransHolder = new FileTransDetailHolder(FileTransYifaActivity.this);
					mFileTransHolder.setYifa(true);
			...
			mLoadingPager.setEmptyString("文件传阅已发详情为空");
			mLoadingPager.setLoadingString("文件传阅已发详情加载中...");
			mLoadingPager.setErrorString("文件传阅已发详情加载失败");
			mLoadingPager.show();
