...
/**
 * @项目名：MobileOA 
 * @类名称：FileTransYishouActivity   
 * @类描述：   文件传阅已收管理类
 * @创建人：HuangXianFeng 
 * @修改人：    
 * @创建时间：2016-4-7 上午11:34:20  
 * @version    
 */
public class FileTransYishouActivity extends BaseActivity {
	...
	FileTransDetailHolder mFileTransHolder = new FileTransDetailHolder(FileTransYishouActivity.this);
	private String keyTag="文件传阅已发";
		...
		if (mLoadingPager == null) {
			mLoadingPager = new LoadingPager(UiUtils.getContext()) {
				...
				public View createSuccessView() {
					...
					System.out.println("mFileTransactionDetail is null:"+mFileTransactionDetail==null);
					mFileTransHolder.setData(mFileTransactionDetail);
					View contentView = mFileTransHolder.getContentView();
					return contentView;
				}
			};
			mLoadingPager.setEmptyString("文件传阅已收详情为空");
			mLoadingPager.setLoadingString("文件传阅已收详情加载中...");
			mLoadingPager.setErrorString("文件传阅已收详情加载失败");
			mLoadingPager.show();
