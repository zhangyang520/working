 ...
 * 
 * @项目名：MobileOA 
 * @类名称：FileTransYishouHolder   
 * @类描述：   已收文件设置数据Holder
 * @创建人：HuangXianFeng 
 * @修改人：    
 * @创建时间：2016-3-20 下午1:19:47  
 * @version    
 *
 */
public class FileTransYishouHolder extends BaseHolder<FileTransaction>{
	...
	public View initView() {
		...
		btnType.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				paramsHashMap.put("Trans2Type","2");
				
				urlParamsEntity.setParamsHashMap(paramsHashMap);
				intent.putExtra("urlParamsEntitiy", urlParamsEntity);
				
				FileTransactionFragment.instance.startActivityForResult(intent, MobileOAConstant.FILE_TRANS_2_IMPORTANT_REQUEST_CODE);
			}
		});
//		
